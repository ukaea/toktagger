...
ANNOTATION_1 = AnnotationIn(label="annotation", validated=True, created_by=AnnotatorTypes.MANUAL_ANNOTATION)
ANNOTATION_2 = TimeRegion(time_min=0.1, time_max=0.2, label="ramp_up", validated=True, created_by=AnnotatorTypes.MANUAL_ANNOTATION)
ANNOTATION_3 = TimePoint(time=0.1, label="disruption", validated=False, uncertainty=0.6, created_by=AnnotatorTypes.PEAK_DETECTION)
ANNOTATION_4 = TimePoint(time=0.3, label="disruption", validated=False, uncertainty=0.4, created_by=AnnotatorTypes.PEAK_DETECTION)
ANNOTATION_5 = TimePoint(time=0.4, label="disruption", validated=False, uncertainty=0.8, created_by=AnnotatorTypes.PEAK_DETECTION)