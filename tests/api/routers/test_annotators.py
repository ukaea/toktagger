...
async def test_annotators_invalid_type(api_client, setup_db):
    ...
    response = await api_client.post(f"/projects/{setup_db['project_id_1']}/samples/{setup_db['sample_id_2']}/annotator/wrong_type", json=params)
...
async def test_annotators(api_client, setup_db):
    ...
    response = await api_client.post(f"/projects/{setup_db['project_id_2']}/samples/{setup_db['sample_id_4']}/annotator/peak_detection", json=params)
