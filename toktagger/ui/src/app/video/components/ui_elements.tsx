...
export function InstancePanel({
  ...
  return (
    <div className="w-full lg:w-56 shrink-0 lg:pl-2 mx-auto">
      ...
      <div className="rounded-lg border bg-black/60 border-gray-700 shadow-sm max-h-[45vh] overflow-y-auto mt-2">
        ...
        {profiles.map((p) => {
          ...
          // IMPORTANT:
          // - The row is a button (good for keyboard + semantics)
          // - The "Delete" control is NOT a button (to avoid nested button)
          // - The "Jump" control is also NOT a button (to avoid nested button)
          return (
            <button
              key={p.key}
              type="button"
            ...
            >
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  {/* Actions column: fixed width + centered icon button + full-width delete */}
                  <div className="w-14 flex flex-col items-stretch gap-1 shrink-0">
                    {/* Not a <button> (prevents nested button warning) */}
                    <span
                      role="button"
                      tabIndex={0}
                      onClick={(e) => {
                    ...
                    <span
                      ...
                      className="w-full rounded-md px-1.5 py-0.5 text-[10px] border border-gray-400/60 text-gray-100 hover:bg-gray-500/15 cursor-pointer select-none inline-flex items-center justify-center"
                      title="Jump to the first frame where this instance appears"
