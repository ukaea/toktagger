...
export const AnnotationToolbar = () => {
    ...
    const { toolingInfo, setToolingCallbacks, toggleEditMode, toolingCallbacks, editMode } = useAnnotationProvider()
    ...
    return (
        <div className="flex flex-col w-50 items-center space-y-3 ">
            ...
            <Button width="size-1600" variant={modeVariant} onPress={toggleEditMode}>{modeText}</Button>
