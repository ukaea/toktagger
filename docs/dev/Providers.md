...
The user interface exposes multiple providers, which expose contexts used for various functions. The providers implemented can be found [here](https://github.com/ukaea/viz-annotation/tree/main/toktagger/ui/src/app/components/providers). With additional information included in the following pages:
